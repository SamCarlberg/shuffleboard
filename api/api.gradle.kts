...
dependencies {
    ...
    // api(group = "org.controlsfx", name = "controlsfx", version = "9.0.0") // Forces users to run with --add-exports javafx.controls/com.sun.javafx.scene.control.inputmap=ALL-UNNAMED
